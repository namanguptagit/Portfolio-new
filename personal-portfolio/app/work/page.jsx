...
const projects = [
  ...
  },
  {
    ...
    description: "A bold and earthly visual identity for a modern coffee brand",
    image: "/assets/work/thumb2.png",
    link: "",
    github: "",
...
const categories = [
  "frontend", "fullstack", "uiux", "branding"
];
...
const Work = () => {
  return (
    <motion.section initial={{ opacity: 0 }} animate={
      ...
      <div className="container w-full mx-auto h-full flex flex-col justify-center">
        ...
        <TabsList className="flex flex-wrap justify-center items-center gap-4 h-full mb-4 xl:mb-0">
          ...
          <div className='h-[400px] scrollbar scrollbar-thumb-accent scrollbar-track-accent/5 overflow-y-scroll xl:overflow-y-visible'>
            {categories.map((category) => {
              return (
                <TabsContent key={category} value={category}><Swiper modules={[Pagination]} pagination={{ clickable: true, dynamicBullets: true }}
                    ...
                    return (
                      <SwiperSlide key={project.id} className='h-full'>
                        <div className='flex flex-col xl:flex-row gap-8 xl:gap-12'>
                          ...
                          <div className='w-full h-[200px] md:h-[300px] xl:h-[400px] relative bg-pink-50/10 order-1 xl:order-none rounded-lg overflow-hidden ml-[05px]'><Image src={project.image} alt={project.image} fill className='object-cover' /></div>
                        </div>
                      </SwiperSlide>
                    );
                  })}
