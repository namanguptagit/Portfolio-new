    ...
    ><div className="container mx-auto px-0">
        <div className="flex flex-col xl:flex-row gap-24 items-center w-full h-[680px]">
          <div className='hidden xl:flex flex-col w-full h-full pt-14 max-w-[430px] relative '> 
            <Image src="/assets/avatar.png" width={320} height={496}
              alt="" className='z-20 relative' />
            <div className='w-full h-[60px] absolute left-0 top-[420px] right-0 bg-gradient-to-t from-primary via-primary/90 z-30'></div>
            <div className='absolute top-[80px] -left-[80px] z-10'><Blob containerStyles="w-[420px] h-[420px]" /></div>
          ...
          <ScrollArea className='w-full h-[680px]'> 
            <div>
              ...
              <h2 className='h2 mb-6'>
                <span className='text-accent'>Naman</span> Gupta
              </h2>
              <p className='max-w-[540px] mb-12 '>I focus on crafting visually stunning, user-friendly web experiences that not only look great but also function seamlessly, ensuring every detail is carefully designed and executed.</p>
